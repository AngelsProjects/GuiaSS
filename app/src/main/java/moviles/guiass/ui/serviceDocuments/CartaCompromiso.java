...
public class CartaCompromiso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carta_compromiso);
        ...
        Picasso.get()
                .load("http://lechtchenko.azurewebsites.net/img/carta_compromiso_servicio_social.png")
